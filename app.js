...
const WORD_LISTS = {
    1: [
        'Ast', 'Arm', 'Auto', 'Ball', 'Bank', 'Baum', 'Bein', 'Bett', 'Bild', 'Blatt',
        'Blume', 'Boot', 'Brot', 'Buch', 'Bus', 'Dach', 'Dame', 'Dino', 'Dose', 'Ei',
        'Ente', 'Esel', 'Fahrrad', 'Fisch', 'Flasche', 'Foto', 'Frau', 'Freund', 'Frosch', 'Gabel',
        'Garten', 'Gast', 'Geist', 'Glas', 'Gras', 'Haar', 'Hahn', 'Hand', 'Haus', 'Heft',
        'Hemd', 'Herz', 'Himmel', 'Holz', 'Hose', 'Hund', 'Hut', 'Igel', 'Insel', 'Jacke',
        'Junge', 'Kabel', 'Karte', 'Katze', 'Käse', 'Keks', 'Kind', 'Kino', 'Kiste', 'Kleid',
        'Kuh', 'Lampe', 'Land', 'Leiter', 'Lied', 'Löwe', 'Lupe', 'Mädchen', 'Mann', 'Maus',
        'Meer', 'Mond', 'Motor', 'Mund', 'Nadel', 'Name', 'Nase', 'Nest', 'Note', 'Ofen',
        'Oma', 'Opa', 'Ohr', 'Paket', 'Papa', 'Park', 'Pferd', 'Pilz', 'Pizza', 'Pinsel',
        'Radio', 'Rad', 'Rabe', 'Regen', 'Ring', 'Rose', 'Rucksack', 'Saft', 'Sand', 'Schaf',
        'Schal', 'Schere', 'Schiff', 'Schnee', 'Schule', 'See', 'Seife', 'Seite', 'Sessel', 'Sonne',
        'Spiel', 'Spiegel', 'Stadt', 'Stein', 'Stift', 'Stock', 'Stuhl', 'Tag', 'Tafel', 'Tasche',
        'Tee', 'Telefon', 'Tiger', 'Tisch', 'Tomate', 'Tor', 'Turm', 'Ufer', 'Uhr', 'Vater',
        'Vogel', 'Wagen', 'Wald', 'Wand', 'Wasser', 'Weg', 'Welt', 'Wind', 'Wiese', 'Wolf',
        'Wort', 'Zahn', 'Zebra', 'Zeit', 'Zelt', 'Zitrone', 'Zoo',
        'gehen', 'laufen', 'lesen', 'malen', 'essen', 'trinken', 'sehen', 'spielen',
        'finden', 'rufen', 'kommen', 'bringen', 'holen', 'geben', 'nehmen', 'stehen',
        'sitzen', 'legen', 'zeigen', 'suchen', 'fragen', 'helfen', 'arbeiten', 'lernen',
        'bauen', 'tanzen', 'lachen', 'weinen', 'fahren', 'kaufen',
        'groß', 'klein', 'alt', 'jung', 'gut', 'schlecht', 'warm', 'kalt',
        'schnell', 'langsam', 'laut', 'leise', 'hell', 'dunkel', 'rot', 'blau',
        'grün', 'gelb', 'braun', 'weiß'
    ],
    2: [
        'Abend', 'Abendessen', 'Ampel', 'Anfang', 'Apfel', 'Arzt', 'Ast', 'Auto',
        'Bäcker', 'Ball', 'Banane', 'Berg', 'Beere', 'Biene', 'Blatt', 'Blume',
        'Boot', 'Brot', 'Brücke', 'Brief', 'Buch', 'Burg', 'Bus', 'Computer',
        'Dach', 'Dorf', 'Ei', 'Elefant', 'Eltern', 'Ende', 'Ergebnis', 'Fenster',
        'Feld', 'Film', 'Fisch', 'Fluss', 'Flügel', 'Foto', 'Freund', 'Frosch',
        'Frucht', 'Fuß', 'Fußball', 'Gabel', 'Garten', 'Geburtstag', 'Gefühl', 'Geld',
        'Geschenk', 'Glück', 'Gras', 'Gurke', 'Haar', 'Hand', 'Haus', 'Heft',
        'Himmel', 'Hobby', 'Holz', 'Huhn', 'Hund', 'Insel', 'Jahr', 'Junge',
        'Käfer', 'Karte', 'Katze', 'Kino', 'Kleid', 'Knopf', 'Kopf', 'Kraft',
        'Kreis', 'Kuchen', 'Lampe', 'Land', 'Laterne', 'Lehrer', 'Leiter', 'Lied',
        'Löwe', 'Luft', 'Mädchen', 'Mann', 'Maus', 'Meer', 'Milch', 'Mond',
        'Motor', 'Mütze', 'Name', 'Nase', 'Nest', 'Nudel', 'Ofen', 'Oma',
        'Opa', 'Paket', 'Papagei', 'Park', 'Pferd', 'Pflanze', 'Pizza', 'Polizei',
        'Radio', 'Rad', 'Regen', 'Ring', 'Rose', 'Rucksack', 'Saft', 'Salat',
        'Sand', 'Schaf', 'Schere', 'Schiff', 'Schnee', 'Schrank', 'Schule', 'See',
        'Seife', 'Seite', 'Sonne', 'Spiel', 'Spiegel', 'Stadt', 'Stein', 'Stift',
        'Straße', 'Stuhl', 'Tag', 'Tafel', 'Tasche', 'Telefon', 'Tiger', 'Tisch',
        'Tomate', 'Turm', 'Uhr', 'Vater', 'Vogel', 'Wagen', 'Wald', 'Wasser',
        'Weg', 'Wind', 'Wiese', 'Wort', 'Zahn', 'Zelt', 'Zeit', 'Zirkus',
        'arbeiten', 'bauen', 'bringen', 'denken', 'essen', 'fahren', 'finden', 'fragen',
        'gehen', 'geben', 'helfen', 'holen', 'kaufen', 'kochen', 'kommen', 'lachen',
        'lernen', 'lesen', 'laufen', 'legen', 'machen', 'malen', 'nehmen', 'rennen',
        'rufen', 'sagen', 'schreiben', 'sehen', 'spielen', 'suchen',
        'freundlich', 'fröhlich', 'glücklich', 'groß', 'klein', 'lang', 'kurz',
        'laut', 'leise', 'mutig', 'ruhig', 'schnell', 'stark', 'schwach', 'warm',
        'kalt', 'hell', 'dunkel', 'lustig', 'traurig'
    ],
    3: [
        'Abenteuer', 'Abfahrt', 'Abfall', 'Abend', 'Adler', 'Adresse', 'Angst', 'Antwort',
        'Apotheke', 'Arbeit', 'Arzt', 'Aufgabe', 'Aufzug', 'Ausflug', 'Auto', 'Bäckerei',
        'Bad', 'Ball', 'Bande', 'Bär', 'Becher', 'Beginn', 'Berg', 'Besuch', 'Bett', 'Biene',
        'Bild', 'Blitz', 'Blume', 'Boot', 'Brief', 'Brille', 'Brücke', 'Buch', 'Burg', 'Bus',
        'Computer', 'Dach', 'Dampf', 'Dank', 'Datum', 'Decke', 'Dorf', 'Drachen', 'Ecke', 'Eimer',
        'Eintritt', 'Elefant', 'Eltern', 'Ende', 'Engel', 'Erde', 'Erfolg', 'Ergebnis', 'Erlebnis', 'Ernte',
        'Erzählung', 'Eule', 'Fahrrad', 'Familie', 'Fenster', 'Ferien', 'Fieber', 'Film', 'Finger', 'Flamme',
        'Flasche', 'Fluss', 'Frage', 'Freund', 'Frühstück', 'Fußball', 'Garten', 'Gebäude', 'Geburtstag', 'Gefahr',
        'Gefühl', 'Geheimnis', 'Geld', 'Gemeinde', 'Geschichte', 'Geschenk', 'Gespräch', 'Gesundheit', 'Gewinn', 'Glas',
        'Glück', 'Gold', 'Gras', 'Grenze', 'Gruppe', 'Hafen', 'Hammer', 'Hand', 'Hase', 'Haus',
        'Heimat', 'Heizung', 'Himmel', 'Hobby', 'Holz', 'Hoffnung', 'Hund', 'Hunger', 'Idee', 'Insel',
        'Jahr', 'Jagd', 'Junge', 'Käfer', 'Käfig', 'Kamera', 'Karte', 'Katze', 'Keller', 'Kind',
        'Kino', 'Kirche', 'Kiste', 'Kleidung', 'Knopf', 'Kopf', 'Kreis', 'Kuchen', 'Kugel', 'Lampe',
        'Land', 'Laterne', 'Lehrer', 'Leiter', 'Licht', 'Lied', 'Luft', 'Mädchen', 'Maler', 'Mann',
        'Maschine', 'Meer', 'Meinung', 'Milch', 'Minute', 'Mond', 'Motor', 'Mütze', 'Name', 'Nase',
        'Nest', 'Note', 'Nudel', 'Ofen', 'Oma', 'Opa', 'Ordnung', 'Paket', 'Papagei', 'Park',
        'Pause', 'Pferd', 'Pflanze', 'Polizei', 'Preis', 'Radio', 'Rad', 'Regen', 'Reihe', 'Reise',
        'Ring', 'Rose', 'Rucksack', 'Saft', 'Salat', 'Sand', 'Schaf', 'Schere', 'Schiff', 'Schloss',
        'Schnee', 'Schrank', 'Schule', 'See', 'Seife', 'Seite', 'Sonne', 'Spiel', 'Spiegel', 'Stadt',
        'Stein', 'Stift', 'Straße', 'Stuhl', 'Tag', 'Tafel', 'Tasche', 'Telefon', 'Tiger', 'Tisch',
        'Tomate', 'Turm', 'Ufer', 'Uhr', 'Urlaub', 'Vater', 'Vogel', 'Wagen', 'Wald', 'Wasser',
        'Weg', 'Wind', 'Wiese', 'Wort', 'Zahn', 'Zeit', 'Zelt', 'Zirkus', 'Zoo',
        'arbeiten', 'bauen', 'beginnen', 'bringen', 'denken', 'entdecken', 'erklären', 'erzählen',
        'fahren', 'finden', 'fragen', 'gewinnen', 'glauben', 'helfen', 'hoffen', 'holen',
        'kaufen', 'kochen', 'kommen', 'lachen', 'lernen', 'lesen', 'laufen', 'legen',
        'machen', 'malen', 'nehmen', 'rennen', 'rufen', 'sagen', 'schreiben', 'sehen',
        'spielen', 'sprechen', 'springen', 'suchen', 'tragen', 'trinken', 'versuchen', 'verstehen',
        'freundlich', 'fröhlich', 'gefährlich', 'geduldig', 'genau', 'glücklich', 'groß', 'klein',
        'lang', 'kurz', 'laut', 'leise', 'lustig', 'mutig', 'ruhig', 'schnell',
        'schwierig', 'stark', 'traurig', 'wichtig'
    ],
    4: [
        'Abenteuer', 'Abfahrt', 'Abflug', 'Abschluss', 'Abstand', 'Adresse', 'Agent', 'Aktion',
        'Anfang', 'Ankunft', 'Anleitung', 'Anruf', 'Antwort', 'Apotheke', 'Arbeit', 'Armee',
        'Artikel', 'Aufgabe', 'Aufnahme', 'Aufsatz', 'Ausdruck', 'Ausflug', 'Ausgang', 'Ausland',
        'Ausstellung', 'Auto', 'Bäckerei', 'Ball', 'Bande', 'Bauernhof', 'Beispiel', 'Beitrag',
        'Beobachtung', 'Bericht', 'Beruf', 'Besuch', 'Beweis', 'Bewegung', 'Bild', 'Bildschirm',
        'Blick', 'Blume', 'Boot', 'Brücke', 'Buch', 'Bühne', 'Computer', 'Dach', 'Dank', 'Datum',
        'Debatte', 'Denken', 'Detail', 'Dorf', 'Drama', 'Ecke', 'Einfluss', 'Einladung', 'Eintritt', 'Einwohner',
        'Eisenbahn', 'Elefant', 'Empfang', 'Ende', 'Energie', 'Erde', 'Erfahrung', 'Erfolg', 'Ergebnis', 'Erklärung',
        'Erlebnis', 'Ernte', 'Erzählung', 'Experiment', 'Fahrrad', 'Familie', 'Fenster', 'Ferien', 'Fieber', 'Film',
        'Finger', 'Flamme', 'Flasche', 'Fluss', 'Frage', 'Freund', 'Frühstück', 'Fußball', 'Garten', 'Gebäude',
        'Geburtstag', 'Gefahr', 'Gefühl', 'Geheimnis', 'Geld', 'Gemeinschaft', 'Geschichte', 'Geschenk', 'Gespräch', 'Gesundheit',
        'Gewinn', 'Glück', 'Gold', 'Grenze', 'Gruppe', 'Hafen', 'Hand', 'Haus', 'Heimat', 'Heizung',
        'Himmel', 'Hobby', 'Hoffnung', 'Hund', 'Hunger', 'Idee', 'Insel', 'Interesse', 'Jahr', 'Junge',
        'Kamera', 'Karte', 'Katze', 'Keller', 'Kind', 'Kino', 'Kirche', 'Kiste', 'Kleidung', 'Knopf',
        'Kopf', 'Kreis', 'Kuchen', 'Kugel', 'Land', 'Laterne', 'Lehrer', 'Leiter', 'Licht', 'Lied',
        'Luft', 'Mädchen', 'Maler', 'Mann', 'Maschine', 'Meer', 'Meinung', 'Milch', 'Minute', 'Mond',
        'Motor', 'Mütze', 'Name', 'Nest', 'Note', 'Ofen', 'Ordnung', 'Paket', 'Papagei', 'Park',
        'Pause', 'Pferd', 'Pflanze', 'Polizei', 'Preis', 'Radio', 'Rad', 'Regen', 'Reihe', 'Reise',
        'Ring', 'Rose', 'Rucksack', 'Saft', 'Salat', 'Sand', 'Schaf', 'Schere', 'Schiff', 'Schloss',
        'Schnee', 'Schrank', 'Schule', 'See', 'Seite', 'Sonne', 'Spiel', 'Spiegel', 'Stadt', 'Stein',
        'Stift', 'Straße', 'Stuhl', 'Tag', 'Tafel', 'Tasche', 'Telefon', 'Tiger', 'Tisch', 'Tomate',
        'Turm', 'Ufer', 'Uhr', 'Urlaub', 'Vater', 'Vogel', 'Wagen', 'Wald', 'Wasser', 'Weg',
        'Wind', 'Wiese', 'Wort', 'Zeit', 'Zelt', 'Zirkus', 'Zoo',
        'beschreiben', 'beweisen', 'diskutieren', 'entdecken', 'entscheiden', 'erforschen', 'erfinden', 'erklären',
        'erzählen', 'gestalten', 'planen', 'prüfen', 'reagieren', 'rechnen', 'sammeln', 'untersuchen',
        'verändern', 'vergleichen', 'verstehen', 'vorbereiten',
        'bequem', 'deutlich', 'einfach', 'erstaunlich', 'gefährlich', 'geduldig', 'genau', 'interessant',
        'nützlich', 'schwierig', 'spannend', 'stolz', 'tapfer', 'vernünftig', 'wichtig', 'wunderbar'
    ]
};
